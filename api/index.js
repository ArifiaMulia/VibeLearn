  ...
  while (retries > 0) {
    try {
      ...
      const courseSeeds = [
        ...
        { title: 'Deploy Live Apps: Manual to Automated CI/CD', description: 'Learn to deploy AI-built apps from your machine to the internet — manually first, then fully automated. Real case: push code from Antigravity to GitHub, then auto-deploy via Coolify.', level: 'intermediate', category: 'devops', order_index: 6, required_plan: 'pro' },
        // ── Cybersecurity Track (SealSuite) ──
        { title: 'SealSuite Fundamentals', description: 'Master the core concepts of SealSuite and Zero Trust data security. Learn about Data Loss Prevention (DLP), AI-powered threat analysis, and risk mitigation using simple, everyday analogies.', level: 'beginner', category: 'cybersecurity', order_index: 7, required_plan: 'free', thumbnail: '/images/sealsuite_fundamental.png' },
        { title: 'SealSuite for Administrators', description: 'Master the SealSuite platform as an IT administrator. Learn Zero Trust architecture, identity management, VPN setup, endpoint security, DLP, and automated threat response from the Admin Console.', level: 'intermediate', category: 'cybersecurity', order_index: 8, required_plan: 'pro', thumbnail: '/images/sealsuite_admin.png' },
        { title: 'SealSuite for End Users', description: 'Get started with SealSuite as an employee. Learn how to use Single Sign-On, connect to VPN, understand device security requirements, and protect company data in your daily work.', level: 'beginner', category: 'cybersecurity', order_index: 9, required_plan: 'free', thumbnail: '/images/sealsuite_user.png' },
      ];
