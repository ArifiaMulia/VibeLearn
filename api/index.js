  ...
  while (retries > 0) {
    try {
      ...
      const courseSeeds = [
        ...
        { title: 'SealSuite Fundamentals', description: 'Master the core concepts of SealSuite and Zero Trust data security. Learn about Data Loss Prevention (DLP), AI-powered threat analysis, and risk mitigation using simple, everyday analogies.', level: 'beginner', category: 'cybersecurity', order_index: 5, required_plan: 'free', thumbnail: '/images/sealsuite_fundamental.png' },
